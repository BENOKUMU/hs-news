          ...
          <div className="author flex">
            ...
            <div className="author-name-date">
              <div className="author-name text-base text-gray-600 pl-2">
                By <span className="underline">Jennifer Hansler</span> , Andy
                Rose and Tami Luhby, CNN
              </div>
              <div className="publish-date text-base text-gray-600 pl-2 flex items-center justify-center">
                ...
                <span className="pl-2">
                  5 minute read Published 9:10 AM EST, Sat December 9, 2025
                </span>
              </div>
            </div>
          </div>
          <div className="content pt-6">
            <div className="image-box bg-gray-100">
              ...
              <div className="heading-tag text-xs text-gray-600 py-5 drop-shadow-sm p-2 border-b border-gray-300">
                The White House budget office ordered a pause on federal grants
                and loans, according to an internal memorandum sent Monday
              </div>
            </div>
